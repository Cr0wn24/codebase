...
ui_codepoint_index_from_mouse_pos(UI_Box *box, String8 edit_str)
{
  ...
  for(U64 i = 0; i < edit_str.size;)
  {
    ...
    Vec2F32 dim = {};
    dim.x = f_advance_from_tag_size_cp(ui_top_font_tag(), ui_top_font_size(), decode.codepoint);
...
ui_line_edit(UI_TextEditState *edit_state, Slice<U8> buffer, U64 *string_length, String8 string)
{
  ...
  ui_seed(ui_hash_from_seed_string(ui_top_seed(), string))
  {
    ...
    if(ui_box_is_focus(box))
    {
      ...
      ui_parent(box)
      {
        F32 advance_to_cursor = f_advance_from_tag_size_string(ui_top_font_tag(), ui_top_font_size(), str8_prefix(buffer_str8, (U64)edit_state->cursor));
        ...
        {
          F32 advance_to_mark = f_advance_from_tag_size_string(ui_top_font_tag(), ui_top_font_size(), str8_prefix(buffer_str8, (U64)edit_state->mark));
        ...
        F32 edit_str_advance = f_advance_from_tag_size_string(ui_top_font_tag(), ui_top_font_size(), edit_str);
