...
#ifndef __UNWIND_H__
#define __UNWIND_H__
#include <third_party/libunwind/__libunwind_config.h>
#include <stdint.h>
#include <stddef.h>
...
typedef _Unwind_Reason_Code (*_Unwind_Stop_Fn)(_Unwind_State state,
                                               _Unwind_Exception *exceptionObject,
                                               struct _Unwind_Context *context);
typedef _Unwind_Reason_Code (*__personality_routine)(_Unwind_State state,
                                                     _Unwind_Exception *exceptionObject,
                                                     struct _Unwind_Context *context);
#else
