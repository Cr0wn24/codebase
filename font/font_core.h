...
function F_GlyphRun f_glyph_run_from_tag_size_str32(Arena *arena, F_Tag tag, U32 size, String32 str32);
function F_GlyphRun f_glyph_run_from_tag_size_str8(Arena *arena, F_Tag tag, U32 size, String8 string);

function F32 f_advance_from_tag_size_str32(F_Tag tag, U32 size, String32 string);
function F32 f_advance_from_tag_size_string(F_Tag tag, U32 size, String8 string);
function F32 f_advance_from_tag_size_cp(F_Tag tag, U32 size, U32 cp);
